...
<?php
	...
	//SQL Scripts
		...
		$equipment = mysqli_query($connect,"SELECT * FROM info_area");
?>
<!DOCTYPE html>
<html lang="en">
<head>
										...
										<li>
											<a href="#"><i class="fa fa-map-marker fa-fw"></i> Manage Locations<span class="fa arrow"></span></a>
												<ul class="nav nav-second-level">
														<li>
																<a href="manage_area.php" class="active">Manage Area</a>
														</li>
														<li>
										...
										<tbody>
											<?PHP
												while($row = mysqli_fetch_assoc($equipment)){
													...
													echo "<td>
													<a class='btn btn-outline btn-success fancybox fancybox.ajax' href='area_edit.php?ppid=".$row['id']."'>Edit</a>
													<a class='btn btn-outline btn-danger' href='database/delete_area.php?ppid=".$row['id']."'>Delete</a>
													</td></tr>";
												}
											?>
										</tbody>
