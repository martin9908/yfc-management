<?PHP
	...
	//SQL Scripts
	$query = mysqli_query($connect,"SELECT * FROM info_area WHERE id = $idnum");
      ...
      <div class="col-lg-12" >
        <div class="panel panel-success">
          ...
          <div class="panel-body">
            <form action="database/edit_area.php" enctype="multipart/form-data" method="post">
              <div class="form-group">
                <div class="row">
                  <div class="col-lg-12">
                    <label>Area ID</label>
                    <input class="form-control" name="AreaID" value="<?PHP echo $id;?>" readonly>
                    <label>Area Name</label>
                    <input class="form-control" name="AreaName" value="<?PHP echo $Area_Name;?>" required>
                    <br>
                    <center>
