            ...
            <div class="col-lg-12" style="width:300px">
                <form action="database/reserve_venue.php" method="post">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="vname" value = "<?PHP echo $vname;?>" disabled>
                        <label>Venue Room</label>
                        <input class="form-control" name="vroom" value = "<?PHP echo $vroom;?>" disabled>
                        <label>Venue Capacity</label>
                        <input class="form-control" name="vcapacity" value = "<?PHP echo $vcapacity;?>" disabled>
                        <label>Venue Description</label>
                        <input class="form-control" name="vdescription" value = "<?PHP echo $vdescription;?>" disabled>
 						<label>Venue Time Limit</label>
                        <input class="form-control" name="vlimit" value = "<?PHP echo $vlimit;?>" disabled>
                        ...
                        <option value = "7:30">7:30 - 9:30</option>
                        <option value = "9:30">9:30 - 11:30</option>
                        ...
                        <input class="form-control" name="audience_number" required>
                    </div>
