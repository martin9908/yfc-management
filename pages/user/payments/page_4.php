<?php
	...
	$payment_reference = isset($_SESSION['payment_reference']) ? $_SESSION['payment_reference'] : null;
                    ...
                    <div class="col-lg-10 col-xs-offset-1">
                    	<div class="panel panel-success">
                            ...
                            <div class="panel-body center-div">
  														<h3>Success! Your registration has been received. Your Events Registration Order</h3>
  														<h2>Transaction ID: <?PHP echo strtoupper($payment_reference) ?></h2>
  														<p>
                                Keep this Transaction ID for your reference. A copy of this registration has also been sent to your email address. For PENDING status, please settle the payment m 3-5 days.
                              </p>
