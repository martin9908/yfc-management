<?php
	...
	//SQL Scripts
  $equipment = mysqli_query($connect, "SELECT info_chapter.id, chapterName, sectorName, areaName FROM `info_sector`, `info_area`, `info_chapter` where `areaId` = `info_area`.`id` AND `sectorId` = `info_sector`.`id`;");
?>
<!DOCTYPE html>
<html lang="en">
<head>
										...
										<li>
											<a href="#"><i class="fa fa-map-marker fa-fw"></i> Manage Locations<span class="fa arrow"></span></a>
												<ul class="nav nav-second-level">
														...
														<li>
																<a href="manage_chapter.php" class="active">Manage Chapter</a>
														</li>
												</ul>
										</li>
										<li>
					...
					<div class="col-lg-12">
                        ...
                        <th>Area Name</th>
                          ...
                          echo "<td>".$row['sectorName']."</td>";
													...
													echo "<td>
													<a class='btn btn-outline btn-success fancybox fancybox.ajax' href='chapter_edit.php?ppid=".$row['id']."'>Edit</a>
													<a class='btn btn-outline btn-danger' href='database/delete_chapter.php?ppid=".$row['id']."'>Delete</a>
													</td></tr>";
												}
											?>
										</tbody>
