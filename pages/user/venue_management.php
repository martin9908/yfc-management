<?php
	...
	$equipment = mysqli_query($connect,"SELECT * FROM
									...
									info_user
								WHERE
									info_venue.idvenue = reservation_venue.idvenue
								AND
									info_user.id = reservation_venue.iduser
								ORDER BY
									reservation_venue.reservation_date;");
?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<body>
		...
		<!-- Navigation -->
			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					...
					<?PHP } else {?>
						<li>
							<a href="venue_management.php" class="active"><i class="fa fa-building-o fa-fw"></i> View Events</a>
						</li>
					<?PHP } ?>
		...
		<div id="page-wrapper" style="margin-bottom: 60px;">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Venue Reservation</h1>
					</div>
					<!-- /.col-lg-12 -->
						<div class="col-lg-12">
